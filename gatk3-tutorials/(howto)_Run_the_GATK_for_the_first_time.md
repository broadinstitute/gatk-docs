...
<p>This time however, if we look inside the working directory, there is a newly created file there called <code class="code codeInline" spellcheck="false">output.txt</code>.</p>
